...
public class DocumentParser {
    ...
    final Logger LOGGER = LoggerFactory.getLogger(DocumentParser.class);
    ...
    public void addInlineSchemaNameMapping(String name, String model) {
        this.inlineSchemaNameMapping.put(name, model);
        this.inlineSchemaNameMappingValues.add(name);
    }
    ...
    public OpenAPI parse() {
        ...
        inlineSchemaNameMappingValues.addAll(inlineSchemaNameMapping.values());
        flattenPaths();
        flattenComponents();
        return openAPI;
    }
    ...
    private String addSchemas(String name, Schema schema) {
        ...
        if (!name.equals(schema.getTitle()) && !inlineSchemaNameMappingValues.contains(name)) {
            LOGGER.info("Inline schema created as {}. To have complete control of the model name, set the `title` field or provide a mapping using addInlineSchemaNameMapping()", name);
        }
